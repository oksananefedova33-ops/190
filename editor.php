<?php require_once dirname(__DIR__) . '/admin/config.php'; ?>
<!doctype html>
...
<link rel="stylesheet" href="/ui/canvas-height/canvas-height.css?v=<?php echo date('YmdHis'); ?>">

<link rel="stylesheet" href="/ui/modules/button-link/button-link.css?v=<?php echo date('YmdHis'); ?>" />
<!-- === В файле /editor/editor.php, ПЕРЕД </head> === -->

<!-- Text Beautify Module -->
<link rel="stylesheet" href="/ui/text-beautify/text-beautify.css?v=<?= time() ?>">
<link rel="stylesheet" href="/ui/text-beautify/image-generate.css?v=<?= time() ?>">

<script src="/ui/text-beautify/presets.js?v=<?= time() ?>"></script>
<script src="/ui/text-beautify/gpt-api.js?v=<?= time() ?>"></script>
<script src="/ui/text-beautify/text-beautify.js?v=<?= time() ?>"></script>
<script src="/ui/text-beautify/image-generate.js?v=<?= time() ?>"></script>
<link rel="stylesheet" href="/ui/text-scroll/text-scroll.css?v=<?php echo date('YmdHis'); ?>" />
<script src="/ui/text-scroll/text-scroll.js?v=<?php echo date('YmdHis'); ?>"></script>
<!-- HTML Preview Images Module -->
<link rel="stylesheet" href="/ui/html-preview-images/html-preview-images.css?v=<?php echo date('YmdHis'); ?>" />
<script src="/ui/html-preview-images/html-preview-images.js?v=<?php echo date('YmdHis'); ?>"></script>
</head><body>
<div class="topbar">
...
<!-- === HTML Preview Modal === -->
<link rel="stylesheet" href="/ui/html-preview/html-preview-modal.css?v=<?php echo date('YmdHis'); ?>">
<script defer src="/ui/html-preview/html-preview-modal.js?v=<?php echo date('YmdHis'); ?>"></script>
<!-- === HTML LangBadge Generator === -->
<link rel="stylesheet" href="/ui/html-langbadge/html-langbadge.css?v=<?php echo date('YmdHis'); ?>">
<script defer src="/ui/html-langbadge/html-langbadge.js?v=<?php echo date('YmdHis'); ?>"></script>
<!-- === HTML Buttons Module === -->
<link rel="stylesheet" href="/ui/html-buttons/html-buttons.css?v=<?php echo date('YmdHis'); ?>">
<script defer src="/ui/html-buttons/html-buttons.js?v=<?php echo date('YmdHis'); ?>"></script>
<script defer src="/ui/html-buttons/html-buttons-integration.js?v=<?php echo date('YmdHis'); ?>"></script>
...
<script>
// Прокидываем базовую высоту холста из конфига
window.EDITOR_BASE_H = <?php echo (int)(defined('CANVAS_H') ? CANVAS_H : 1500); ?>;
</script>

<script src="assets/editor.js?v=<?php echo date('YmdHis'); ?>"></script>
<script defer src="/ui/canvas-height/canvas-height.js?v=<?php echo date('YmdHis'); ?>"></script>
...
<!-- Язык SEO для экспорта -->
<script src="/ui/export-seo-lang/export-seo-lang.js?v=<?php echo date('YmdHis'); ?>"></script>
<!-- Ключевые слова, author и Breadcrumbs -->
<script src="/ui/export-keywords/export-keywords.js?v=<?php echo date('YmdHis'); ?>"></script>
